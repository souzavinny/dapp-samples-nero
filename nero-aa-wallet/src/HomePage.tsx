...
const NFT_EXTENSION_ADDRESS = '0xC86Fed58edF0981e927160C50ecB8a8B05B32fed';
...
const HomePage = () => {
  ...
  const handleMintNFT = async () => {
    ...
    try {
      ...
      // In a production app, this should be stored on IPFS or another decentralized storage
      // For this demo, we'll directly use the image URL as the tokenURI
      // A proper implementation would upload this JSON to IPFS first
      ...
      // In a real app, you would upload the metadata to IPFS and use that URI
      await execute({
        function: 'mint',
